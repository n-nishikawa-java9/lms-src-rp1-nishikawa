...
//                isInfoOver = true;
//                $('#lms-infomation-hide').attr('data-content', infoDto.content);
//                $('#lms-infomation-hide').click();
//          }
//        });
      } else {
        ...
        for (var i = 0; i < trElementAmount; i ++) {
          ...
          for (var j = 0; j < tdElementAmount; j++) {
            ...
            if (inputElementId.indexOf('[') != -1) {
              ...
              var replaceId = inputElementId.substring(0, inputElementName.lastIndexOf('[')) + '[' + i + ']';
